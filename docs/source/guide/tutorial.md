...
```
(see `lsgck` [below](#lsgck-utility) for more information))
...
=====================================================================================================
File                           | N | Date   | nork  | nvec  | MAE      | RMSE     | CORR     | Model -----------------------------------------------------------------------------------------------------
msh5000_0_14.gck               | N | 01-07  | 0     | 14    |  5.72611 |  9.31035 | 0.998454 | 8     
msh5000_0_16.gck               | N | 01-07  | 0     | 16    |  5.76409 |  9.58759 |  0.99836 | 8     
msh5000_0_18.gck               | N | 01-07  | 0     | 18    |  5.78288 |  9.53691 | 0.998377 | 8     
msh5000_0_20.gck               | N | 01-07  | 0     | 20    |  5.85565 |  9.83475 | 0.998274 | 8     
msh5000_0_22.gck               | N | 01-07  | 0     | 22    |  6.32957 |  10.3498 | 0.998098 | 18    
msh5000_0_24.gck               | N | 01-07  | 0     | 24    |  6.31202 |  10.3299 | 0.998104 | 18    
msh5000_0_26.gck               | N | 01-07  | 0     | 26    |   6.3004 |  10.3119 |  0.99811 | 18    
msh5000_0_28.gck               | N | 01-07  | 0     | 28    |  6.29507 |  10.3037 | 0.998113 | 20    
msh5000_0_30.gck               | N | 01-07  | 0     | 30    |  6.29384 |   10.305 | 0.998112 | 18    
msh5000_0_32.gck               | N | 01-07  | 0     | 32    |  6.29199 |  10.3007 | 0.998113 | 18    
msh5000_1_14.gck               | N | 01-07  | 1     | 14    |  5.66815 |  9.23544 | 0.998479 | 13    
msh5000_1_16.gck               | N | 01-07  | 1     | 16    |   5.6565 |  9.21246 | 0.998486 | 13    
msh5000_1_18.gck               | N | 01-07  | 1     | 18    |  5.64279 |  9.21242 | 0.998486 | 13    
msh5000_1_20.gck               | N | 01-07  | 1     | 20    |  5.62521 |  9.18476 | 0.998495 | 13    
msh5000_1_22.gck               | N | 01-07  | 1     | 22    |   5.6364 |  9.20005 |  0.99849 | 13    
msh5000_1_24.gck               | N | 01-07  | 1     | 24    |  5.63548 |  9.19139 | 0.998492 | 13    
msh5000_1_26.gck               | N | 01-07  | 1     | 26    |  5.63286 |  9.18491 | 0.998494 | 13    
msh5000_1_28.gck               | N | 01-07  | 1     | 28    |  5.63332 |  9.18029 | 0.998496 | 13    
msh5000_1_30.gck               | N | 01-07  | 1     | 30    |  5.63607 |  9.18178 | 0.998495 | 13    
msh5000_1_32.gck               | N | 01-07  | 1     | 32    |   5.6303 |  9.17123 | 0.998499 | 13    
msh5000_2_14.gck               | N | 01-07  | 2     | 14    |  5.73108 |   9.3363 | 0.998444 | 13    
msh5000_2_16.gck               | N | 01-07  | 2     | 16    |  5.69772 |  9.30471 | 0.998455 | 13    
msh5000_2_18.gck               | N | 01-07  | 2     | 18    |  5.68289 |  9.28981 |  0.99846 | 13    
msh5000_2_20.gck               | N | 01-07  | 2     | 20    |   5.6624 |  9.24796 | 0.998474 | 8     
msh5000_2_22.gck               | N | 01-07  | 2     | 22    |  5.65936 |  9.23767 | 0.998477 | 4     
msh5000_2_24.gck               | N | 01-07  | 2     | 24    |  5.65469 |  9.23181 | 0.998479 | 13    
msh5000_2_26.gck               | N | 01-07  | 2     | 26    |  5.64736 |  9.20701 | 0.998487 | 13    
msh5000_2_28.gck               | N | 01-07  | 2     | 28    |  5.64908 |  9.20855 | 0.998487 | 13    
msh5000_2_30.gck               | N | 01-07  | 2     | 30    |   5.6448 |  9.20893 | 0.998486 | 13    
msh5000_2_32.gck               | N | 01-07  | 2     | 32    |  5.63463 |     9.19 | 0.998493 | 13    
=====================================================================================================
...
(fastprofiles-target)=
### Fast profiles
The topo method has an `interactive` switch which, if set to `True`, allows the direct tracing of profiles from the map. 
...
List information extracted from the `.gck` files present in a directory. More functionality is planned to be added in the future. The first column of the printout after the filename, labeled "N", indicates whether [normalization](#normalization-target) has been used; its possible values ​​are: "Y", "N", and "?" (the latter for `.gck` files prior to version 1.0.0dev1). Example printout:

```
===============================================================================
File                           | N | Date   | nork  | nvec  | MAE      | Model 
-------------------------------------------------------------------------------
montebea_0_12.gck              | Y | 02-04  | 0     | 12    |  99.1853 | 11    
montebea_1_12.gck              | N | 02-04  | 1     | 12    |  122.957 | 20    
msh5000_1_18.gck               | ? | 01-22  | 1     | 18    |  5.46032 | 13    
tene5000_0_30.gck              | ? | 01-15  | 0     | 30    |  1.73859 | 18    
===============================================================================
```
...
This utility allows an in-depth look inside `.gck` files.
...
```bash
$ catgck -h
usage: catgck [-h] [-p] gckfile

Extract and print information from `.gck` file

positional arguments:
  gckfile        GCK file to inspect

options:
  -h, --help     show this help message and exit
  -p, --precise  use maximum precision for ZK coefficients

pyGEKO Analysis Tool
```
